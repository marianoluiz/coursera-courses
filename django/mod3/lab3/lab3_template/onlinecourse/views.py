...
def enroll(request, course_id):
    ...
    if request.method == 'POST':
        ...
        # viewname='onlinecourse:course_details':
            # onlinecourse is the app namespace (likely defined in your app’s urls.py)
            # course_details is the view name
...
""" the lesson dont need a function since it is already from Course"""